...
class CommandeService
{
    ...
    public function createCommande(array $data): Commande
    {
        ...
        try {
            ...
            $montants = $this->calculateMontants($data['articles'], $data['frais_livraison'], $data['remise'] ?? 0);
            ...
            $this->createArticlesCommande($commande, $data['articles']);
     ...
     * Créer les articles de commande
     */
    private function createArticlesCommande(Commande $commande, array $articles): void
    {
        foreach ($articles as $article) {
            ArticlesCommande::create([
                ...
                'prix_total_article' => $article['quantite'] * $article['prix_unitaire'],
