...
class PromotionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'cible_client' => [
                'required',
                'string',
                'in:tous,nouveaux,vip,reguliers'
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'cible_client.in' => 'La cible doit être : tous, nouveaux, VIP ou inactifs.',
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            if ($this->input('date_debut') && $this->input('date_fin')) {
                ...
                $dureeJours = $dateFin->diffInDays($dateDebut);
                ...
                if ($dureeJours < 1) {
                    $validator->errors()->add('date_fin', 
                        'Une promotion doit durer au moins un jour.');
                }
            }
